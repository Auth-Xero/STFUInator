 ...
 */
public interface IBrEdrPairingListener {
     ...
     *
     * <p>The application should call {@link BrEdrPairingManager#respondToIoCapability(int, boolean)}
     ...
     * they match and call {@link BrEdrPairingManager#confirmNumericComparison(int, boolean)}.
     *
     * @param connectionHandle ACL connection handle
     * @param address          peer device address
     ...
     * displayed on the peer device and call {@link BrEdrPairingManager#enterPasskey(int, int)}.
     *
     * @param connectionHandle ACL connection handle
     * @param address          peer device address
