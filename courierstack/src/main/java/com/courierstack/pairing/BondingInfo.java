...
public final class BondingInfo {
    ...
    public String getAddressString() {
        return PairingConstants.formatAddress(address);
    }
    ...
    public boolean isMitmProtected() {
        return PairingConstants.isMitmProtected(linkKeyType);
    }
    ...
    public String getLinkKeyTypeString() {
        return PairingConstants.getLinkKeyTypeString(linkKeyType);
    }
    ...
    public int getSecurityLevel() {
        if (linkKeyType == PairingConstants.KEY_TYPE_AUTHENTICATED_P256) {
            return 3;
    ...
    public static BondingInfo create(byte[] address, byte[] linkKey, int linkKeyType) {
        return builder()
                ...
                .authenticated(PairingConstants.isMitmProtected(linkKeyType))
                .build();
    }
}