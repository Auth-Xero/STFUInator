...
import com.courierstack.hci.HciPacket;
 ...
 */
class HidlHalAdapter extends android.hardware.bluetooth.V1_0.IBluetoothHciCallbacks.Stub
        implements IBluetoothHal {

    private static final String TAG = "HciHidlHal";

    private final android.hardware.bluetooth.V1_0.IBluetoothHci mHciService;
    private final IBluetoothHalCallback mCallbacks;
     ...
     */
    static HidlHalAdapter create(IBluetoothHalCallback callbacks) {
        ...
        try {
            ...
            if (service != null) {
                ...
                return new HidlHalAdapter(service, callbacks);
            }
    ...
    private HidlHalAdapter(android.hardware.bluetooth.V1_0.IBluetoothHci service,
                           IBluetoothHalCallback callbacks) {
        mHciService = service;
