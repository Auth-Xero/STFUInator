 ...
 */
final class AidlHalAdapter extends android.hardware.bluetooth.IBluetoothHciCallbacks.Stub
     ...
     */
    static AidlHalAdapter create(IBluetoothHalCallback callbacks) {
        ...
        return new AidlHalAdapter(service, callbacks);
    }

    private AidlHalAdapter(android.hardware.bluetooth.IBluetoothHci service,
